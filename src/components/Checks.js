            ...
            <div>
                ...
                <div className="container">
                    ...
                    <div className="col-lg-8">
                        ...
                        <input type="text" className="form-control" id="nameOnCard" placeholder="Full name on card" />
                        <CardSection />
                        <br />
                        {/* <div className="col-12">
...
if (document.getElementById('checks')) {
    ReactDOM.render(<Checks />, document.getElementById('checks'));
}
...
export default function InjectedCheckoutForm() {
    return (
      <ElementsConsumer>
        {({ stripe, elements }) => (
          <Checks stripe={stripe} elements={elements} />
        )}
      </ElementsConsumer>
    );
  }
