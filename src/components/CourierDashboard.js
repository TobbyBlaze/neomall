...
export default class CourierDashboard extends Component{
    ...
    logoutHandler = e => {
        ...
        var a=localStorage.getItem("cauthen");
        this.setState({ loading: true })
        

        axios
            // .get('http://localhost/yummypizza/public/api/auth/logout',{
            .get('https://neomallapi.herokuapp.com/api/auth/c-logout',{
                headers: {
    ...
    profileHandler = e => {
        ...
        axios
            ...
            .post('https://neomallapi.herokuapp.com/api/auth/updateCourier', this.state
            , {
                headers: {
    ...
    passwordHandler = e => {
        ...
        axios
            // .post('localhost/yummypizza/public/api/auth/signup', this.state)
            // .post('http://localhost/yummypizza/public/api/auth/signup', this.state
            .post('https://neomallapi.herokuapp.com/api/auth/updateCourierPassword', this.state
            , {
                headers: {
