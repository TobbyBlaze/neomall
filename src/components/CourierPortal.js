...
export default class CourierPortal extends Component {
    ...
    render() {
        ...
        const { id, name, last_name, email, password, confirm_password, phone_number_1, phone_number_2, store_name, store_pics, address_1, address_2, zip, business_reg_no, business_reg_doc, tin, vat, vat_info_doc, bank_name, acct_holder_name, bank_acct_number, bank_code, iban, swift, bank_info, loading } = this.state
                        ...
                        <div className="card active">
                            ...
                            <div className="card-body">
                                ...
                                <div className="form-group col-12">
                                    ...
                                    <input type="email" name="email" className="form-control" id="exampleInputEmail1"  value={email} onChange={this.changeHandler} required  />
                                </div>
                                <div className="form-group col-12 mt-1">
                                    <label htmlFor="exampleInputPassword1">Password</label>
                                    <input type="password" name="password" className="form-control" id="exampleInputPassword1"  value={password} onChange={this.changeHandler} required />
                                </div>
            {/* <!--
                                        ...
                                        <div className="accordion accordion-portal" id="accordionExample2">
                                            ...
                                            <div className="form-group col-12 collapse show" id="seller-acct" aria-labelledby="seller-signup-1" data-parent="#accordionExample2">
                                                <div className="form-group col-12">
                                                    ...
                                                    <input type="text" name="name" className="form-control" id="name"  value={name} onChange={this.changeHandler} required />
                                                </div>
                                                <div className="form-group col-12">
                                                    <label htmlFor="last_name">Last name</label>
                                                    <input type="text" name="last_name" className="form-control" id="last_name"  value={last_name} onChange={this.changeHandler} required />
                                                </div>
                                                <div className="form-group col-12">
                                                    <label htmlFor="exampleInputEmail2">Email address</label>
                                                    <input type="email" name="email" className="form-control" id="exampleInputEmail2"  value={email} onChange={this.changeHandler} required />
                                                </div>
                                                <div className="form-group col-12 mt-1">
                                                    <label htmlFor="exampleInputPassword3">Password</label>
                                                    <input type="password" name="password" className="form-control" id="exampleInputPassword3"  value={password} onChange={this.changeHandler} required />
                                                </div>
                                                <div className="form-group col-12 mt-1">
                                                    <label htmlFor="exampleInputPassword4">Repeat Password</label>
                                                    <input type="password" name="confirm_password" className="form-control" id="exampleInputPassword4"  value={confirm_password} onChange={this.changeHandler} required />
                                                </div>
                                                <div className="form-group col-12">
                                                    <label htmlFor="phone_number_1">Phone number</label>
                                                    <input type="text" name="phone_number_1" className="form-control" id="phone_number_1"  value={phone_number_1} onChange={this.changeHandler} required />
                                                </div>
                                                <div className="form-group col-12">
                                            ...
                                            <div className="form-group col-12 collapse" id="seller-business" aria-labelledby="seller-signup-2" data-parent="#accordionExample2">
                                                <div className="form-group col-12">
                                                    ...
                                                    <input type="text" name="store_name" className="form-control" id="store_name"  value={store_name} onChange={this.changeHandler} required />
                                                </div>
                                                <div className="form-group col-12">
                                                ...
                                                <div className="form-group col-12">
                                                    ...
                                                    <input type="text" name="address_1" className="form-control" id="address_1"  value={address_1} onChange={this.changeHandler} required />
                                                </div>
                                                <div className="form-group col-12">
                                            ...
                                            <div className="form-group col-12 collapse" id="seller-payment" aria-labelledby="seller-signup-3" data-parent="#accordionExample2">
                                                <div className="form-group col-12">
                                                    ...
                                                    <input type="text" name="bank_name" className="form-control" id="bank_name"  value={bank_name} onChange={this.changeHandler} required />
                                                </div>
                                                <div className="form-group col-12">
                                                    <label htmlFor="acct_holder_name">Account holder name</label>
                                                    <input type="text" name="acct_holder_name" className="form-control" id="acct_holder_name"  value={acct_holder_name} onChange={this.changeHandler} required />
                                                </div>
                                                <div className="form-group col-12">
                                                    <label htmlFor="bank_acct_number">Bank account number</label>
                                                    <input type="text" name="bank_acct_number" className="form-control" id="bank_acct_number"  value={bank_acct_number} onChange={this.changeHandler} required />
                                                </div>
                                                {/* <div className="form-group col-12">
