...
export default class Error extends Component{
    ...
    render(){
        const { carts, cartsNum, errorMsg, delcart, loading, q, searchLoading } = this.state;
        var a=localStorage.getItem("authen");
        if(a == null){
            var auth = false;
        }else{
    ...
    // };
        ...
        return(
            ...
            <div>
                ...
                <div class="image image-overlay" style={{backgroundImage:'url(assets/images/background-3.jpg)'}}></div>
                <div class="container">
                    <div class="row align-items-center justify-content-center vh-100">
                    <div class="col-10 col-md-8 col-lg-4 text-center">
                        <h1 class="display-1 font-weight-bold">404</h1>
                        <p class="lead">The page you were looking for wasn't found</p>
                    </div>
                    </div>
                </div>
                </section>
